...
//		HAL_UART_Receive(&huart1, ackReadImageDataLength, 8, 1000);
		HAL_UART_Transmit(huart, readImageDataLength, 5, 1000); 		/*Transmit readImageDataLength command*/
		HAL_UART_Receive(huart, ackReadImageDataLength, 8, 1000);
...
//		HAL_UART_Transmit(&huart1, readImageData, 16, 1000); 	/*Transmit read image command*/
		HAL_UART_Transmit(huart, readImageData, 16, 1000); 	/*Transmit read image command*/
...
//		HAL_UART_Receive(&huart1, imageData, dataLength, 1000);
		HAL_UART_Receive(huart, imageData, dataLength, 1000);
...
//		HAL_UART_Receive(&huart1, ackStopCapture, 5, 1000);
		HAL_UART_Transmit(huart, stopCapture, 5, 1000);
		HAL_UART_Receive(huart, ackStopCapture, 5, 1000);
